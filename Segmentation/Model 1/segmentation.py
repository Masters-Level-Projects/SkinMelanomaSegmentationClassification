...
def double_conv11(in_channels, out_channels):
    return nn.Sequential(
...
class UNet(nn.Module):
    ...
    def __init__(self, n_class):
        ...
        self.fcn_layer1 = single_conv1(32, 128)
        self.fcn_layer2 = single_conv1(128, 512)
        self.fcn_layer3 = single_conv1(512, 256 + 128)
        self.fcn_layer4 = single_conv1(256 + 128, 64 + 32)
        self.fcn_layer5 = single_conv1(32, 16)
        #self.fcn_layer6 = single_conv1(32, 16)
        
        self.conv11_post = double_conv11(32, 16)
        self.conv7_post = double_conv7(32, 32)
        self.conv3_post = double_conv3(32, 32)
        self.conv1_post = single_conv1(32, 16)
        
        self.conv1_enc = single_conv1(16 + 32 + 32 + 16, 32)
    ...
    def forward(self, x):
        ...
        fcn = self.fcn_layer1(x)
        fcn = self.maxpool(self.maxpool(fcn))
        ...
        x = F.relu(x + fcn)
        fcn = self.fcn_layer2(x)
        fcn = self.maxpool(fcn)
        ...
        x = F.relu(x + fcn)
        fcn = self.fcn_layer3(x)
        fcn = self.upsample(self.upsample(fcn))
        ...
        x = self.dconv_up1(x)
        #fcn = self.fcn_layer5(x)
        
        x_11 = self.conv11_post(x)
        x_7 = self.conv7_post(x)
        x_3 = self.conv3_post(x)
        x_1 = self.conv1_post(x)
        
        x = torch.cat([x_11, x_7, x_3, x_1], dim=1)
        x = self.conv1_enc(x)
        #x = fcn + x
